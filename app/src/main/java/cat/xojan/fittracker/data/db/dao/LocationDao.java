...
public class LocationDao extends AbstractDao<Location, Long> {
    ...
    */
    ...
    private Query<Location> workout_LocationsQuery;
    ...
    public List<Location> _queryWorkout_Locations(long workoutId) {
        synchronized (this) {
        ...
        Query<Location> query = workout_LocationsQuery.forCurrentThread();
